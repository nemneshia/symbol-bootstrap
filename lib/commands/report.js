...
class Report extends command_1.Command {
    async run() {
        ...
        await new service_1.BootstrapService(logger).report(Object.assign(Object.assign({}, flags), { workingDir }));
    }
}
exports.default = Report;
Report.description = 'it generates reStructuredText (.rst) reports describing the configuration of each node.';
Report.examples = [`$ symbol-bootstrap report`];
Report.flags = {
