...
export default class ModifyMultisig extends Command {
    ...
    static flags: {
        ...
        minRemovalDelta: import("@oclif/parser/lib/flags").IOptionFlag<number | undefined>;
        minApprovalDelta: import("@oclif/parser/lib/flags").IOptionFlag<number | undefined>;
        addressAdditions: flags.IOptionFlag<string | undefined>;
        addressDeletions: flags.IOptionFlag<string | undefined>;
    };
    run(): Promise<void>;
}
